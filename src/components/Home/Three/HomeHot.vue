<template>
	<div class="hot">
		<div class="mkback" style="background: #EEEEEE;">
			<div style="padding: 15px 0 6px 20px;">
				<b>全部</b>
			</div>
			<div style="padding-bottom: 5px;">
				<div style="width: 30px;border:1px orangered solid;margin-left: 20px;"></div>
			</div>
		</div>
		<!-- 帖子架构 -->
			...
			<div class="mkback" style="margin-top: 10px;" :style="{display:item.Id!=PinHuibtn?'none':('none'==PinHuiif?'none':'block')}">
				...
				<div>
					<dl class="row" style="width:94%;margin:0 auto;padding-top:16px;margin-bottom: 0px;">
						<dt class="col-1">
							<img class="pl_img" :src="PinJieUserImg(UserData.UserImg)" style="object-fit: cover;" />
						</dt>
				...
				<div v-if="Renullcz">
					<div v-for="(Reitem,index) in Replylist" :key="index">
						...
						<dl class="row" style="width:94%;margin:0 auto;">
							...
							<dt class="col-1"><img style="width:40px;height:40px;border-radius:20px;object-fit: cover;" :src="PinJieUserImg(Reitem.UserImg)" /></dt>
							<dd class="col-11">
								<dl class="row">
									<dd class="col-12">
											...
											<dl class="row" style="width:90%;margin:0 auto;padding-top:10px;">
												...
												<dd class="col-11" style="height:auto;">
													<dl class="row" style="margin-bottom:-10px;">
														...
														<dd class="col-7"></dd>
														<dd class="col-1"><a href="javascript:" @click="CoDianzang(Coitem.Id,item.Id)" class="pl_text1"><i class="iconfont icon-zan"></i>&nbsp;<span
																 v-text="Coitem.Fabsum"></span></a></dd>
														<dd class="col-2" style="text-align:center;"><a @click="Huifusj(coindex,index)" href="javascript:void(0)" class="pl_text1"><i
																 class="iconfont icon-pinglun"></i>&nbsp;回复</a></dd>
														<dd class="col-12" :style="{display:(coindex==Huifubtn&&index==Huifubtn1)?('none'==Huifuif?'none':'block'):'none'}">
...
<script>
	...
	export default {
		...
		methods: {
			...
			//获取所有帖子信息
			async SePostData() {
				const res = await this.$http.post('Index/SePostFirst', {
